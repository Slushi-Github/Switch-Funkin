...
class Mods
{
	...
	inline public static function mergeAllTextsNamed(path:String, ?defaultDirectory:String = null, allowDuplicates:Bool = false)
	{
		...
		#if switch
		// On Switch, don't prepend assets/ for paths that already have romfs:/ or sdmc:/
		if (!defaultDirectory.startsWith('romfs:/') && !defaultDirectory.startsWith('sdmc:/'))
		{
	...
	inline public static function directoriesWithFile(path:String, fileToFind:String, mods:Bool = true)
	{
		...
		#if switch
		// Normalize path for Switch
		var normalizedPath = path;
		if (!normalizedPath.startsWith("romfs:/") && !normalizedPath.startsWith("sdmc:/"))
			normalizedPath = "romfs:/" + normalizedPath;

		// Main folder
		if (FileSystem.exists(normalizedPath + fileToFind))
			foldersToCheck.push(normalizedPath + fileToFind);
		#else
		// Main folder
	...
	inline public static function parseList():ModsList
	{
		...
		{
			#if switch
			var modsListPath = "sdmc:/switch/Switch-Funkin/modsList.txt";
			#else
	...
	private static function updateModList()
	{
		...
		#if switch
		var modsListPath = "sdmc:/switch/Switch-Funkin/modsList.txt";
		// Ensure the directory exists on Switch
		var modsDir = "sdmc:/switch/Switch-Funkin";
		if (!FileSystem.exists(modsDir))
		{
			...
			{
				SlDebug.log('Failed to create mods directory: $e');
			}
		}
		#else
		var modsListPath = 'modsList.txt';
		...
		try
		{
			...
			updatedOnState = true;
			// SlDebug.log('Saved modsList.txt');
		}
		catch (e:Dynamic)
		{
			SlDebug.log('Failed to save modsList.txt: $e');
		}
		#end
	}
