...
class DiscordClient
{
	...
	{
		SlDebug.log('Discord: Error ($errorCode: ${cast(message, String)})');
	}

	private static function onDisconnected(errorCode:Int, message:cpp.ConstCharStar):Void
	{
		SlDebug.log('Discord: Disconnected ($errorCode: ${cast(message, String)})');
	}
	...
	public static function initialize()
	{
		...
		if(!isInitialized) SlDebug.log("Discord Client initialized");
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		//SlDebug.log('Discord RPC Updated. Arguments: $details, $state, $smallImageKey, $hasStartTimestamp, $endTimestamp, $largeImageKey');
	}
	...
	public static function loadModRPC()
	{
		...
		if(pack != null && pack.discordRPC != null && pack.discordRPC != clientID)
		{
			...
			//SlDebug.log('Changing clientID! $clientID, $_defaultID');
		}
	}
	#end
