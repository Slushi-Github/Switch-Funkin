...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Switch Funkin' Team"],
			["Slushi",		"slushi",		"Main Programmer and Head of Switch Funkin', ported Psych Engine to Switch",					"https://github.com/Slushi-Github",	"8FD9D1"],
			[""],
			["Psych Engine Team"],
	...
	function changeSelection(change:Int = 0)
	{
		...
		//SlDebug.log('The BG color is: $newColor');
	...
	function pushModCreditsToList(folder:String)
	{
		...
		//SlDebug.log('/data/credits-${ClientPrefs.data.language}.txt');
