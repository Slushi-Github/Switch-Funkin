...
class StoryMenuState extends MusicBeatState
{
	...
	function selectWeek()
	{
		if (!weekIsLocked(loadedWeeks[curWeek].fileName))
		{
			...
			{
				SlDebug.log('CHANGED MOD DIRECTORY, RELOADING STUFF');
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		//SlDebug.log(Mods.currentModDirectory + ', menudifficulties/' + Paths.formatToSongPath(diff));
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		//SlDebug.log('Pos of ' + lastDifficultyName + ' is ' + newPos);
		if(newPos > -1)
		{
